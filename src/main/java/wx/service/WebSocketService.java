...
public class WebSocketService {
    ...
    public void sendChatMessage(InMessage message) {
        ...
        template.convertAndSend("/chat/single/"+message.getToId(),
                new OutMessage(message.getId(),String.valueOf(message.getFromId()), message.getContent(),message.getAvatar(),message.getCreateTime(),message.getOrderId(),message.getContentType()));
    }
